...
<head>
<meta charset=utf-8 />
<meta name="description" content="Phim lẻ, Phim lẻ  | Phim lẻ  hay tuyển chọn | Phim lẻ  mới nhất  2018" /><meta name="og:type" content="website" /><meta name="og:title" content="Phim lẻ  | Phim lẻ  hay tuyển chọn | Phim lẻ  mới nhất  2018" /><meta name="og:description" content="Phim lẻ" />
<meta name="robots" content="INDEX" />
<meta property="og:url" content="<?php echo $host?>" />
<base href="http://vhmmovie.com/" />
<title>Phim lẻ, Phim lẻ  | Phim lẻ  hay tuyển chọn | Phim lẻ  mới nhất  2018</title>
<?php 
...
<section class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8 float-left"  style="margin-bottom:10px">
  <section class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="line-height:50px;">
     ...
     <a href="<?php echo $host?>phim-le.html" class="text-warning font-weight-bold"> Phim Lẻ  </a> 
  </section>
	<?php
    $limit = 8;
    if(isset($_GET['page']) && filter_var($_GET['page'], FILTER_VALIDATE_INT, array('min_range' => 1)))
    {
      ...
      $sql = "SELECT * FROM phim WHERE MALOAI = 2 ORDER BY ID DESC LIMIT {$one_page}, {$limit}";
    }
    else
    {
      $page = 0;
      $sql = "SELECT * FROM phim WHERE MALOAI = 2 ORDER BY ID DESC LIMIT {$page}, {$limit}";
    }
  ...
  <div class=" clearfix"></div> <br />
   <ul class="pagi">
    ...
    <li class="pre" style="<?php if(!isset($_GET['page']) or $_GET['page'] == 1) echo 'display: none;' ?>">
      <a href="<?php echo $host;?>phim-le.html?page=<?php if(isset($_GET['page']) && $_GET['page'] > 0) $previous = $_GET['page']; echo --$previous; ?>"><</a>
    </li>
    <?php
      $sql3 = "SELECT ID, MALOAI FROM phim WHERE MALOAI = 2";
  ...
  ?>
      <li><a class="<?php if(!isset($_GET['page']) && $i == 1) echo 'active'; ?>" href="<?php echo $host;?>phim-le.html?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
  <?php
      }
    ?>
    <!-- Nút Next -->
      <li class="nx" style="<?php if($_GET['page'] == $number_page or $number_page == 1) echo 'display: none;' ?>">
        <a href="<?php echo $host;?>phim-le.html?page=<?php if(!isset($_GET['page'])){echo 2;}elseif($_GET['page']){$next = $_GET['page']; echo ++$next;} ?>">></a>
      </li>
  </ul>
</section>

<section class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 float-left"  style="">

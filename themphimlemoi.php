...
<form action="" method="post" enctype="multipart/form-data" name="addf" target="_parent">
    <table class="table table-bordered">
        <tr>
            <td colspan="2" class="text-center text-uppercase bg-primary text-light font-weight-bold">Thêm Phim Lẻ Mới</td>
        </tr>
        <?php
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                {
                    header('location: ./quan-ly-phim-le.html');
                 }
                else
                {
                    echo `<tr>
                            ...
                            <div class="alert alert-danger alert-dismissible">
                                ...
                                Thêm Phim Lẻ <strong>Thất Bại!</strong> 
                            </div>
                            </td>
                        </tr>`;
                }

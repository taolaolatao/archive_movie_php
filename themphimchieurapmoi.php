...
<form action="" method="post" enctype="multipart/form-data" name="addf" target="_parent">
    <table class="table table-bordered">
        <tr>
            <td colspan="2" class="text-center text-uppercase bg-primary text-light font-weight-bold">Thêm Phim Chiếu Rạp Mới</td>
        </tr>
        <?php
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                // Kiểm tra Insert Thành Công Chưa
                if(mysqli_affected_rows($conn) == 1)
                {
                    header('location: ./quan-ly-phim-chieu-rap.html');
                 }
                else
                {
                    echo `<tr>
                            ...
                            <div class="alert alert-danger alert-dismissible">
                                ...
                                Thêm Phim Chiếu Rạp <strong>Thất Bại!</strong> 
                            </div>
                            </td>
                        </tr>`;
                }
        ...
        <tr>
            <td>Tên Phim</td>
            <td><input type="text" name="tenphim" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" value="<?php if(isset($tenPhim)) echo $tenPhim; ?>" autocomplete="off" required /></td>
        </tr>
        <tr>
            <td>Link Phim</td>
            <td><input type="text" name="linkphim" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" value="<?php if(isset($linkPhim)) echo $linkPhim; ?>" autocomplete="off" required />
            </td>
        </tr>
        <tr>
            <td>Link Download</td>
            <td><input type="text" name="linkdown" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" value="<?php if(isset($linkDown)) echo $linkDown; ?>" autocomplete="off" />
            </td>
        </tr>
        <tr>
            <td>Link Ảnh Thumbnail</td>
            <td><input type="text" name="thumbnail" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" value="<?php if(isset($thumbnail)) echo $thumbnail; ?>" autocomplete="off" required />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Tóm Tắt</td>
            <td>
                <textarea name="description" id="editor1" rows="10" rows="10"class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" required><?php if(isset($description)) echo $description; ?></textarea>

...
<form action="" method="post" enctype="multipart/form-data" name="addf" target="_parent">
	<table class="table table-bordered">
    	<tr>
        	<td colspan="2" class="text-center text-uppercase bg-primary text-light font-weight-bold">Thêm Thông Tin Phim Bộ</td>
        </tr>
        <tr>
        ...
        <tr>
        	<td>Trạng Thái </td>
            <td><input type="text" name="sotap" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" placeholder="VD: Tập 25/55..." required /></td>
        </tr>
        <tr>
            <td>Tên Đạo Diễn</td>
